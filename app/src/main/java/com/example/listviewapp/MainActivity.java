...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(
                new Goods("Hiểu lòng con trẻ",
                        "Shop Minh Long Book",R.drawable.hieu_long_con_tre));
        arrayList.add(
                new Goods("Ca nấu lẩu, nấu mì mini...",
                        "Shop Devang",R.drawable.ca_nau_lau));
        arrayList.add(
                new Goods("1KG KHÔ GÀ BƠ TỎI ...",
                        "Shop Devang",R.drawable.ga_bo_toi));

        arrayList.add(
                new Goods("Xe cần cẩu đa năng",
                        "Shop Thế giới đồ chơi",R.drawable.xa_can_cau));
        arrayList.add(
                new Goods("Đồ chơi dạng mô hình",
                        "Shop Thế giới đồ chơi",R.drawable.do_choi_dang_mo_hinh));
        arrayList.add(
                new Goods("Lãnh đạo giản đơn",
        ...
        arrayList.add(
                new Goods("Hiểu lòng con trẻ...",
                        "Shop LTD Food",R.drawable.hieu_long_con_tre));
        arrayList.add(
                new Goods("Xe cần cẩu đa năng",
                        "Shop Thế giới đồ chơi",R.drawable.xa_can_cau));
        arrayList.add(
        ...
        arrayList.add(
                new Goods("Ca nấu lẩu, nấu mì mini...",
                        "Shop LTD Food",R.drawable.ca_nau_lau));
        arrayList.add(
                new Goods("Hiểu lòng con trẻ",
                        "Shop Minh Long Book",R.drawable.hieu_long_con_tre));
